...
class TypePartDataTable extends DataTable
{
    ...
    {  
        ...
        //delete modal
        $deleteModal = "
        <div class='modal fade deleteSurvey' id='delete_modal".$data->id_typepart."' tabindex='-1' role='dialog' aria-labelledby='exampleModalSizeLg' aria-hidden='true'>
            <form action='". route('typepart.delete',['id' => $data->id_typepart]) ."' method='post' id='form-update' enctype='multipart/form-data'>
        ...
        //edit modal
        $editModal = "
        <div class='modal fade' id='edit_modal".$data->id_typepart."' tabindex='-1' aria-hidden='true'>
            <form action='".route('typepart.update', ['id' => $data->id_typepart ]) ."' method='post'>
                                ...
                                <div class='row'>
                                    <div class='col-md-6 fv-row'>
                                        <div class='d-flex flex-column mb-7 fv-row'>
                                            ...
                                            <input type='text' class='form-control form-control-solid @error('type_nama') is-invalid @enderror' required placeholder='' name='type_nama' value='".$data->type_nama."' />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        $viewModal = "
        <div class='modal fade' id='view_modal".$data->id_typepart."' tabindex='-1' aria-hidden='true'>
            <div class='modal-dialog modal-dialog-centered mw-650px'>
                <div class='modal-content'>
                    <div class='modal-header'>
                        ...
                        <div class='flex-equal me-5'>
                            <table class='table table-flush fw-bold gy-2'>
                                <tr>
                                    ...
                                    <td class='text-gray-800'>".$data->type_nama."</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class='modal-footer'>
                        <button type='reset' class='btn btn-success me-3' data-bs-toggle='modal' data-bs-target='#edit_modal".$data->id_typepart."'>Edit</button>
                        <button type='reset' class='btn btn-danger me-3' data-bs-toggle='modal' data-bs-target='#delete_modal".$data->id_typepart."'>Delete</button>
                    </div>
        ...
        <div class='menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg fw-bold fs-7 w-175px py-4' data-kt-menu='true'>
            <div class='menu-item menu-state-bg px-3'>
                <a href='#' class='menu-link px-3' data-bs-toggle='modal' data-bs-target='#view_modal".$data->id_typepart."'>
                    <span class='menu-icon'><i class='bi bi-eye'></i></span>
                    <span class='menu-title'>View</span>
                </a>
            </div>
            <div class='menu-item menu-state-bg px-3'>
                <a href='#' class='menu-link px-3' data-bs-toggle='modal' data-bs-target='#edit_modal".$data->id_typepart."'>
                    <span class='menu-icon'><i class='bi bi-pencil-square'></i></span>
                    <span class='menu-title'>Edit</span>
                </a>
            </div>
            <div class='menu-item menu-state-bg px-3'>
                    <a href='#' class='menu-link px-3' data-bs-toggle='modal' data-bs-target='#delete_modal".$data->id_typepart."'>
