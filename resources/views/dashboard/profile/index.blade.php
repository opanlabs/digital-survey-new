...
@section('content')
<form action='{{ route('profile.edit', ['id' => Auth::user()->id_user]) }}' method="post">
    @csrf
    @method('put')
<!--begin::Row-->
               ...
               <div class="d-flex flex-column">
                   ...
                   <div class="d-flex align-items-center">
                    <div class="image-input image-input-outline me-6" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                        ...
                        <div class="image-input-wrapper w-125px rounded-circle h-125px" style="background-image: url(assets/media/avatars/300-1.jpg)"></div>
                    ...
                    <div class="d-flex flex-column">
                        <h1 class="fw-bolder d-flex">{{ Auth::user()->name }}</h1>
        ...
        <div class="card mb-5 h-lg-100">
            <div class="card-body card-p">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" name="phone_number" class="form-control form-control-lg" placeholder="Name" value="{{ Auth::user()->phone_number }}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" name="email" class="form-control form-control-lg" placeholder="Name" value="{{ Auth::user()->email }}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
        ...
        <div class="card mb-5 h-lg-100">
            <div class="card-body card-p">
                ...
                {{-- <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="password" name="current_password" class="form-control form-control-lg" placeholder="Current Password" value="">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="password" name="current_password" class="form-control form-control-lg" placeholder="New Password" value="">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div> --}}
